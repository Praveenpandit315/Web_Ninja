...
function toggleVoice() {
    ...
    if (!recognition) {
        ...
        recognition.onend = function () {
            isRecording = false;
            document.getElementById("voiceStatus").innerText = "Tap to use voice input";
        };
    }
...
function analyzeSymptoms() {
    ...
    resultBox.innerHTML = `
        <h4 class="font-semibold mb-2">Possible Condition:</h4>
        <p class="text-gray-600">Common Viral Infection</p>
        <p class="mt-2 text-sm text-gray-500">Recommendation: Rest, stay hydrated, consult doctor if symptoms persist.</p>
    `;
}
...
function analyzeScan() {
    ...
    resultBox.innerHTML = `
        <h4 class="font-semibold mb-2">AI Analysis Result:</h4>
        <p class="text-gray-600">No major abnormalities detected.</p>
    `;
}
document.getElementById("navProfileImage").onclick = function () {
    document.getElementById("navProfileInput").click();
};

// ================= UPDATE NAV PROFILE =================
function updateNavProfile(event) {
    ...
    reader.onload = function () {
        ...
        localStorage.setItem("navProfileImage", imageData);
    };
...
window.addEventListener("DOMContentLoaded", function () {
    ...
    const savedImage = localStorage.getItem("navProfileImage");
